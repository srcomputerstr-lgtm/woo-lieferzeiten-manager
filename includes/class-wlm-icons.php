...
class WLM_Icons {
    ...
    public static function get_icon($icon, $class = '') {
        $icons = array(
            ...
            'truck-xxl' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"></rect><path d="M16 8h4l3 3v5h-7V8z"></path><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle><text x="8" y="11" font-size="6" font-weight="bold" fill="currentColor" stroke="none">XXL</text></svg>',
        );
