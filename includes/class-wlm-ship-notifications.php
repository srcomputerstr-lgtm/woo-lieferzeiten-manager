        ...
        <body>
            <div class="email-container">
                <div class="email-header">
                    ...
                    <h1 style="margin: 0 0 10px 0; font-size: 28px; color: #000000 !important;">📦 Versandliste</h1>
                    <p style="margin: 0; font-size: 16px; color: #000000 !important;"><?php echo esc_html($date_formatted); ?></p>
                </div>
